 ...
 * @author Alejandro
 */
public class GUIAddComanda extends javax.swing.JFrame  {
    ...
    public GUIAddComanda(EmpleadoServicio<Administrativo> servicio) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIAddComanda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new GUIAddComanda(servicioPrueba).setVisible(true);
            }
        });
    }
