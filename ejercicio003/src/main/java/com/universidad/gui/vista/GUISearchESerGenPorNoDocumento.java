...
//        this.txtNoDocumento.setText(" ");
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        try {
            ...
            this.lblSalario.setText("$ " + formato.format(serGenerales.getSalarioBase()));
            this.lblEstatus.setText(serGenerales.getEstatus());
            limpiar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUISearchESerGenPorNoDocumento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
