...
public class GUIPrincipal extends javax.swing.JFrame {
  ...
  private MaestroDetalleServicio maestroDetalleServicio;
    ...
    private void initComponents() {
        ...
        CrudComandas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CrudComandasActionPerformed(evt);
            }
        });
        ...
        jMenuItemBuscarComanda.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemBuscarComandaActionPerformed(evt);
            }
        });
        ...
        jMenuItemActualizarComanda.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemActualizarComandaActionPerformed(evt);
            }
        });
        CrudComandas.add(jMenuItemActualizarComanda);

        jMenuItemEliminarComanda.setText("Eliminar Comanda");
        jMenuItemEliminarComanda.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemEliminarComandaActionPerformed(evt);
            }
        });
    ...
    private void jMenuItemVerComandasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemVerComandasActionPerformed
        GUIListComandas gui = new GUIListComandas(this.comandaServicio);
        gui.setVisible(true);
    ...
    private void jMenuItemActualizarComandaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemActualizarComandaActionPerformed
