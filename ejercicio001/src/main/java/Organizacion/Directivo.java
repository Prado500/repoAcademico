...
public class Directivo extends Empleado {
    ...
    public Directivo(int numProgDirige, int nivelMando, String noDocumento, String tipoDocumento, double salarioBase, String genero, LocalDate fechaNacimiento, String estado) {
